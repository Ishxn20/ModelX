...
function ThemeToggle() {
  ...
  return (
    <Tooltip title={isDark ? 'Switch to light mode' : 'Switch to dark mode'} placement="left">
      ...
      >
        {isDark ? (
          <LightModeIcon sx={{ fontSize: '1.15rem', transition: 'transform 400ms cubic-bezier(0.16,1,0.3,1)', transform: 'rotate(0deg)' }} />
        ) : (
          <DarkModeIcon sx={{ fontSize: '1.15rem', transition: 'transform 400ms cubic-bezier(0.16,1,0.3,1)', transform: 'rotate(0deg)' }} />
        )}
      </IconButton>
    </Tooltip>
  );
