      ...
      <Box
        sx={{
          ...
          background: isDark
            ...
            : 'linear-gradient(135deg, rgba(255, 255, 255, 0.94) 0%, rgba(246, 245, 241, 0.96) 100%)',
          backdropFilter: 'blur(24px)',
          WebkitBackdropFilter: 'blur(24px)',
          border: isDark ? '1px solid rgba(244, 240, 232, 0.08)' : '1px solid rgba(24, 22, 15, 0.08)',
          boxShadow: isDark
            ? '0 1px 0 rgba(244, 240, 232, 0.04) inset, 0 16px 40px rgba(0, 0, 0, 0.32)'
            : '0 1px 0 rgba(255, 255, 255, 0.9) inset, 0 16px 36px rgba(24, 22, 15, 0.08)',
          position: 'relative',
          overflow: 'hidden',
              ...
              >
                <Box
                  ...
                  sx={{
                    ...
                    background: isActive
                      ? 'rgba(157, 141, 208, 0.12)'
                      : 'transparent',
                    transition: 'all 350ms cubic-bezier(0.16, 1, 0.3, 1)',
                    '&:hover': {
                      background: isActive
                        ? 'rgba(157, 141, 208, 0.16)'
                        : isDark ? 'rgba(244, 240, 232, 0.04)' : 'rgba(24, 22, 15, 0.04)',
          ...
          >
            <Box
              sx={{
                ...
                background: isDark
                  ? 'linear-gradient(180deg, rgba(31, 35, 44, 0.6) 0%, rgba(23, 26, 34, 0.4) 100%)'
                  : 'linear-gradient(180deg, rgba(255, 255, 255, 0.88) 0%, rgba(246, 245, 241, 0.72) 100%)',
                display: 'flex',
                alignItems: 'center',
                ...
                <Box
                  sx={{
                    ...
                    background: isDark
                      ...
                      : 'linear-gradient(135deg, rgba(157, 141, 208, 0.16) 0%, rgba(194, 181, 232, 0.20) 100%)',
            ...
            <Box
              sx={{
                ...
                background: isDark ? 'rgba(16, 18, 24, 0.6)' : 'rgba(255, 255, 255, 0.74)',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'space-between',
                flexShrink: 0,
            ...
            >
              <IconButton
                ...
                sx={{
                  ...
                  '&:hover': { opacity: 1, background: 'rgba(157, 141, 208, 0.12)' },
                }}
              >
                    ...
                    sx={{
                      ...
                      background:
                        idx === currentCard
                            ...
                            : isDark ? 'rgba(244, 240, 232, 0.10)' : 'rgba(24, 22, 15, 0.16)',
                      cursor: 'pointer',
